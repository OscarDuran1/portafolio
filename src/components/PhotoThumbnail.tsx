...
const PhotoThumbnail = ({ photo, onClick }: PhotoThumbnailProps) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative cursor-pointer overflow-hidden rounded-xl focus-within:ring-2 focus-within:ring-cyan-500 focus-within:ring-offset-2 focus-within:ring-offset-zinc-900`}
    ...
    >
      <LazyLoadImage
        ...
        effect="blur"
        className="w-full h-full object-cover transition-transform duration-1000 ease-in-out group-hover:scale-105 rounded-xl"
      />
